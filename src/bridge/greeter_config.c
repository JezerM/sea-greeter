...
GreeterConfig_branding_getter_cb(ldm_object *instance, JSCValue *object)
{
  ...
  jsc_value_object_set_property(value, "background_images_dir",
      jsc_value_new_string(context, background_images_dir));
  jsc_value_object_set_property(value, "logo_image",
      jsc_value_new_string(context, logo_image));
  jsc_value_object_set_property(value, "user_image",
      jsc_value_new_string(context, user_image));
  return value;
}
...
GreeterConfig_greeter_getter_cb(ldm_object *instance, JSCValue *object)
{
  ...
  jsc_value_object_set_property(value, "debug_mode",
      jsc_value_new_boolean(context, debug_mode));
  jsc_value_object_set_property(value, "detect_theme_errors",
      jsc_value_new_boolean(context, detect_theme_errors));
  jsc_value_object_set_property(value, "screensaver_timeout",
      jsc_value_new_number(context, screensaver_timeout));
  jsc_value_object_set_property(value, "secure_mode",
      jsc_value_new_boolean(context, secure_mode));
  jsc_value_object_set_property(value, "theme",
      jsc_value_new_string(context, theme));
  jsc_value_object_set_property(value, "icon_theme",
      jsc_value_new_string(context, icon_theme));
  jsc_value_object_set_property(value, "time_language",
      jsc_value_new_string(context, time_language));
  return value;
}
...
GreeterConfig_features_getter_cb(ldm_object *instance, JSCValue *object)
{
  ...
  jsc_value_object_set_property(value, "battery",
      jsc_value_new_boolean(context, battery));
  ...
  jsc_value_object_set_property(backlight, "enabled",
      jsc_value_new_boolean(context, backlight_enabled));
  jsc_value_object_set_property(backlight, "value",
      jsc_value_new_number(context, backlight_value));
  jsc_value_object_set_property(backlight, "steps",
      jsc_value_new_number(context, backlight_steps));

  jsc_value_object_set_property(value, "backlight",
      backlight);
  return value;
}
...
GreeterConfig_initialize(
  ...
  if (GreeterConfig_object != NULL) {
    jsc_value_object_set_property(
        global_object,
        "greeter_config",
        GreeterConfig_object->value
        );
    return;
  }

  JSCClass *GreeterConfig_class = jsc_context_register_class(
      js_context,
      "__GreeterConfig",
      NULL,
      NULL,
  ...
  JSCValue *greeter_config_object = jsc_value_new_object(
      js_context,
      GreeterConfig_object,
      GreeterConfig_class
      );
